...
export default class AllMediaStore extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            instances: [],
    ...
    componentDidMount() {
        ...
        let querypath = '/search/?scan=mediastore-containers';
    ...
    render() {
        ...
        return (
            <div className="default" style={{ padding: "20px", fontSize: "14px" }}>
                <center><h2>All MediaStore Containers</h2></center>
                <br />
